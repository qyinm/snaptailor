...
| `gandalf export` | Write `gandalf.toml` from existing local agent configs. `gandalf import` is a backward-compatible alias. |
...
<CardGroup cols={3}>
  ...
  <Card title="export" href="/cli/export">
    Export local setup to a manifest
  </Card>
